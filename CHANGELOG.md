...
### Released
- Released **agentobserve-dashboard** publicly as a reviewable operating system for platform governance.
...
### Shipped
- Cut the first coherent internal version of **agentobserve-dashboard** with stable domain objects, review surfaces, and decision outputs.
